...
fun main(args: Array<String>) {
    ...
    headers.setBasicAuth("m.michelini@yopmail.com", "\$2a\$10\$PaRVbn4bQHrMcep52jcv2Oky0WbEBllVE2irKNzUgoGQrrF376Bli")

    // create cart
    val cart = ArrayList<CartProductDTO>()
    cart.add(CartProductDTO(ProductDTO("pane"), 2))
    cart.add(CartProductDTO(ProductDTO("pesce"), 3))
